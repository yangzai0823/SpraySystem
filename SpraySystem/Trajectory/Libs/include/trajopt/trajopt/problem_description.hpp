...
TrajOptProbPtr TRAJOPT_API ConstructProblem(const Json::Value&,
...
constructed to hold the parameters. Then it later gets converted to a Cost
object by the hatch method
*/
 ...
 */
struct TRAJOPT_API PoseCostInfo : public TermInfo,
                                  public MakesCost,
                                  public MakesConstraint {
  int timestep;
  Vector3d xyz;
  Vector4d wxyz;
 ...
 */
struct TRAJOPT_API JointPosCostInfo : public TermInfo, public MakesCost {
  DblVec vals, coeffs;
  int timestep;
  void fromJson(const Value& v);
  void hatch(TrajOptProb& prob);
...
/**
 ...
 max_displacement
 */
struct TRAJOPT_API CartVelCntInfo : public TermInfo, public MakesConstraint {
...
*/
struct TRAJOPT_API JointVelCostInfo : public TermInfo, public MakesCost {
  DblVec coeffs;
  void fromJson(const Value& v);
  void hatch(TrajOptProb& prob);
...
struct TRAJOPT_API JointVelConstraintInfo : public TermInfo,
                                            public MakesConstraint {
  DblVec vals;
  int first_step, last_step;
  void fromJson(const Value& v);
...
*/
struct TRAJOPT_API CollisionCostInfo : public TermInfo, public MakesCost {
 ...
 */
struct TRAJOPT_API JointConstraintInfo : public TermInfo,
                                         public MakesConstraint {
...
// dq - 2022-08-14
struct TRAJOPT_API ZAxisCostInfo : public TermInfo,
                                   public MakesCost,
                                   public MakesConstraint {
  ZAxisCostInfo() = default;
  virtual ~ZAxisCostInfo() {}
  int timestep;
  Eigen::Vector3d zdir;
  // Vector3d pos_coeffs, rot_coeffs;
  Vector3d coeffs;
  KinBody::LinkPtr link;
  OR::RobotBase::ManipulatorPtr manip;
  virtual void fromJson(const Value& v) override;
  virtual void hatch(TrajOptProb& prob) override;
  DEFINE_CREATE(ZAxisCostInfo);
};

struct TRAJOPT_API CartXYZCostInfo : public TermInfo,
                                     public MakesCost,
                                     public MakesConstraint {
  CartXYZCostInfo() = default;
  virtual ~CartXYZCostInfo() {}
  int timestep;
  Eigen::Vector3d xyz_;
  // Vector3d pos_coeffs, rot_coeffs;
  Vector3d coeffs;
  ...
  virtual void fromJson(const Value& v) override;
  virtual void hatch(TrajOptProb& prob) override;
  DEFINE_CREATE(CartXYZCostInfo);
};

/**
 \brief pose error

 See trajopt::CartToolPoseInfo
 */
struct TRAJOPT_API CartToolPoseInfo : public TermInfo,
                                      public MakesCost,
                                      public MakesConstraint {
  int timestep;
  Vector3d xyz;
  ...
  void fromJson(const Value& v);
  void hatch(TrajOptProb& prob);
  DEFINE_CREATE(CartToolPoseInfo);
};
